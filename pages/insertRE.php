<html>
    ...
    <body>
      ...
      <h2>Add Resident (Does Not Process Room Assignment)</h2>

      <hr />

      <form method="POST" action="insertRE.php"> <!--refresh page when submitted-->
          ...
          Preference List: <input type="text" minlength="5" maxlength="45" name="PreferenceList"> <br /><br />
          Age: <input type="number" min="1" max="150" name="insAge"> <br /><br />
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['insStudentNumber'],
                ":bind2" => $_POST['insName'],
                ":bind3" => $_POST['insContactInformation'],
                ":bind4" => $_POST['insPreferenceList'],
                ":bind5" => $_POST['insAge'],
                ":bind6" => $_POST['insUniversity']
            );

            if ($_POST['insStudentNumber'] != NULL) {
              $alltuples = array (
                  $tuple
              );
              ...
              echo "Student Number Cannot Be Empty";
            }
        }
